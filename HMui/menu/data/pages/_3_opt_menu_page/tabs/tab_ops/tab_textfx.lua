local MiniPage        = require("HMui.menu.data.pages._3_opt_menu_page.mini_page")
...
local function _target_tab_actors(gm, mini, state)
    ...
    local target_list = TextFx.replace_card_textfx(mini, gm, MiniPage.build_card_textfx(state))
