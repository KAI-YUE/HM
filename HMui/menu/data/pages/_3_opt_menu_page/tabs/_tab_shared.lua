local C, Tree     = require("HMfns.animate.color.color_const"), require("HMEng.ui_actors.common.tree")
...
function M.option_widgets(gm, cfg)
    ...
    widgets[#widgets + 1] = {  --- basic settings
        style  = "scrollable_discrete_entry",   T    = { x = scrollable_x, y = scrollable_y, w = 15, h = 14 },
        id     = list_id,                       loop = N,                               
        axis   = "vertical",                    visible_count = visible_count,

        --- discrete entry settings
