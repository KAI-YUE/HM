...
local Shared      = require(_tabs_dir .. "_tab_shared")
local Entries     = require(_tabs_dir .. "_3_4_system.entries")
local Common      = require(_tabs_dir .. "_3_4_system.widgets.common")
local Widgets     = {
    lang_selector   = require(_tabs_dir .. "_3_4_system.widgets.lang_selector"),
    slider          = require(_tabs_dir .. "_3_4_system.widgets.txt_speed_slider"),
    on_off_switcher = require(_tabs_dir .. "_3_4_system.widgets.auto_save_switcher"),
    widget_with_btn = require(_tabs_dir .. "_3_4_system.widgets.reset_defaults_btn"),
}
