...
function M.fade_in(gm, mini)
    ...
    for i, child in ipairs(mini.page_child_widgets or {}) do _spring_draw_offset(gm, child, "_save_menu_mini_child_enter", _mini_item_from, _dilated_spring(_mini_item_spring, _mini_item_dilation), _mini_at(_mini_item_start + (i - 1)*_mini_item_stagger), _queue) end
