...
local Arrows    = require("HMui.menu.data.pages._1_load_2_save_pages._2_save.anims.anim_arrows")
local MiniPage  = require("HMui.menu.data.pages._1_load_2_save_pages._2_save.anims.anim_mini_page")
...
function M.enter(gm, panel, page, ctx)
    ...
    local slot_list = Tree.find_child_by_id(root, "save_slot_list"); if not slot_list then return end
