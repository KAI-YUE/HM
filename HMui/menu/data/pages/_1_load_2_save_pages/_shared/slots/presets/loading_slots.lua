...
local function load_slot_opts()  return { list_id = "load_slot_list", page_id_prefix = "load_page", slot_id_prefix = "load_slot", hook_fn = "load_slot", primary_hint_i18n_key = "load" } end
