...
function GridZone:move(dt)
    ...
    if not moved and not (self.card_layout_dirty or self.pawn_layout_dirty or self.card_layout_live or self.reveal_layout_live or self.pawn_layout_live) then return end
