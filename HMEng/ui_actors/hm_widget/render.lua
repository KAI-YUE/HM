...
function HMWidget:draw_self(opts)
    ...
    local enqueue_before_draw = (cfg.renderer == "stroked_page" or cfg.renderer == "art_page" or cfg.renderer == "scrollable_discrete_entry" or cfg.renderer == "scrollable_continuous")
