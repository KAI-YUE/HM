...
function M.is_page_slot(self, target)                              if not target then return N end; for _, child in ipairs(self.scrollable_page_items or {}) do if child == target then return Y end; end; return N; end
