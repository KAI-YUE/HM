...
local function _sprite_bg_cfg(self)
    ...
    out.shadow_parallax = bg.shadow_parallax or out.shadow_parallax
...
function M.draw(self)
    ...
    local ctx = setmetatable({ config = cfg, shadow_parallax = cfg.shadow_parallax or self.shadow_parallax }, { __index = self })
