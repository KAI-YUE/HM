local Setup   = require("HMEng.ui_actors.hm_widget.renderers.sprite_brew.single_sprite.setup")
...
M.config_keys = {
    ...
    "sprite_flip_x",            "sprite_flip_y",             "fit_axis",
    "sprite_overlays",
    "bg",                        "sprite_bg",
    ...
    "shadow",                    "shadow_color",            "hover_safe_time",
