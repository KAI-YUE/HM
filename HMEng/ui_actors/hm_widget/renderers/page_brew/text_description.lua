...
---______________________________________
function M.set_hover_description(self, fx)
    ...
    if cfg.description_hover_key == desc_key then cfg.description_hover_source = fx; return end
...
--- Helper: _source_still_hovered | source_waits_for_reveal
local function _source_still_hovered(source)     return source and not source.REMOVED and source.states and source.states.hover and source.states.hover.is; end
...
function M.clear_hover_description(self, immediate, force)
    ...
    if not force and _source_still_hovered(cfg.description_hover_source) then return end
