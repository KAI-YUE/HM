...
local function _build_paint(args)
    if args.bg_paint then return args.bg_paint end

    local paint = {
        shader = _paint_arg(args, "shader") or "_1_watercolor_edge",
        color  = args.bg_fill_color or args.bg_sprite_color or ctd,
    }
    ...
    paint.feather_px  = _paint_arg(args, "feather_px") or 0.08
    ...
    paint.paint_seed_entry = _paint_seed_entry(args, paint)
...
local function _hover_edge_enabled(args) return args.bg_hover_edge == Y or args.hover_edge == Y end
...
local function _paint_rect_child_cfg(id, args)
    ...
    return {
        ...
        --- hover edge settings
        hover_edge              = hover_edge,                                       hover_edge_color        = args.bg_hover_edge_color or args.hover_edge_color or C.CREAM,
        ...
        hover_edge_grace_s      = args.bg_hover_edge_grace_s or args.hover_edge_grace_s or 0.06,
        hover_edge_fade_s       = args.bg_hover_edge_fade_s or args.hover_edge_fade_s or 0.12,

        --- color settings
        fill_color = fill_color,          idle_color = { fill_color = fill_color },
        hover_tint = args.bg_hover_tint or args.hover_tint or 0, parent_hover_tint = args.bg_parent_hover_tint ~= N,
