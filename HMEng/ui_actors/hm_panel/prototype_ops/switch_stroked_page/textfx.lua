...
--- Helper: set_slot_alpha | fade_list | fade_children_out | ordered_reveal
...
local function _fade_children_out(gm, list, delay) for _, fx in ipairs(list or {}) do for _, child in ipairs(fx.children or {}) do child.page_switch_fading_out = Y; ChildFadeTree.fade_tree_to(child, gm, 0, delay) end end end
...
function M.start(widget, gm, page, delay)
    ...
    _fade_children_out(gm, old_list, delay)
