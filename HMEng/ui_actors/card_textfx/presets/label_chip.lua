...
--- use case
----------------------------
--- Small flat label chip for secondary save-slot facts, such as playtime.
--- Looks like a clean black-on-white sticker with a watercolor wipe backing.
--- Use when the text should read as compact metadata, not the main title.
