local BattlePreviewZone = require("HMEng.entities.board.battlepreviewzone")
...
local function _new_side_zone(gm, battle, api, x, y, w, h, side, column)
    local zone = BattlePreviewZone(gm, x, y, w, h, {
        card_limit        = 4,
        highlighted_limit = 0,
        type              = "battle_" .. side,
        battle_side       = side,
...
local function _pending_zone(gm, x, y, w)
    return BattlePreviewZone(gm, x, y, w, 1.45*gm.card_h, {
        card_limit        = 4,
        highlighted_limit = 0,
        type              = "battle_pending",
        preview_pad_x      = 0.10,
...
local function _new_foe_info_zones(gm, start_x, field_w, foe_y)
    ...
    return {
        deck = BattlePreviewZone(gm, start_x, y, deck_w, 1.35*gm.card_h, {
        ...
        hand = BattlePreviewZone(gm, start_x + deck_w + 0.28, y, hand_w, 1.35*gm.card_h, {
