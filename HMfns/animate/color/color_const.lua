...
local C = {
    ...
    CARD = {
        BASE = _hex("#F1E8DFFF"),
        SUIT = {
            F  = _hex("#CC2C37FE"),          W  = _hex("#52B4B4FF"),             M  = _hex("#575757FB"),        
            R  = _hex("#483B3FFD"),          E  = _hex("#D84C55FD"),             D  = _hex("#F18657FF"),              
            H  = _hex("#EE555EFE"),          C  = _hex("#312627FD"),             S  = _hex("#312627FD"),         
            SM = _hex("#E3DAE3FE")
        }
    },

    HUD = {
        DARK           = _hex("#423D3AFF"),  LIGHT_EDGE         = _hex("#F3ECDEFF"),     BLUE_THEME = _hex("#70A39EFF"),
        THEME_L_GREEN  = _hex("#EDEBDDFF"),  THEME_D_GREEN      = _hex("#AAA882FF"),

        STATUS_HP_RED  = _hex("#D75976FF"),  STATUS_FULL_BROWN  = _hex("#E29241FF"),     STATUS_MBAG    = _hex("#EFC2A6FF")
    },
