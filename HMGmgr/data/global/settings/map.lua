...
----------------------------------
    ...
    local M_w,    M_h     = 1.4, 1.4

    local tile_shader = DebugFlags.fps.enable_tile_shader and DebugFlags.fps.tile_shader or nil

    self.Mcfg  = {  n_rows = M_rows,  n_cols      = M_cols,   tile_w       = M_w,  tile_h = M_h,
        atlas_key     = "grass",
        tile_shader = tile_shader,
        random_tiles = N,
        tile_overdraw = 0.02,         fblend_world_phase_scale = 0.1,   tile_shader_uniforms_once = Y,
    ...
    self.TPcfg = { atlas_key  = "terrain",     tile_h   = 0.72*M_h,  tile_w    = 0.72*M_w,    spawn_pr = 0.5,
        anim = Y, model_key = "white_birch", anim_debug_spawn = { enabled = Y, row = 10, col = 15, seed = "anim_terrain_debug" },
